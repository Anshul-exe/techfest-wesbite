  ...
  return (
    ...
    >
      <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6 h-full flex flex-col justify-center">
        <div className="font-light text-gray-500 sm:text-xl dark:text-gray-400"> {/* Increased font size */}
          <h1 className="mb-6 text-5xl tracking-tight font-extrabold text-gray-900 dark:text-white"> {/* Increased heading size */}
            About us
          </h1>
          <p className="mb-6 text-lg font-semibold"> {/* Increased font size */}
